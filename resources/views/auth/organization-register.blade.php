                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select
                                            ...
                                            @foreach ($organization_types as $id => $entry)
                                                <option value="{{ $id }}"
                                                    {{ old('organization_type_id') == $id ? 'selected' : '' }}>
                                                    {{ $entry }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-20">
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.organization.fields.website_helper') }}</span>
                                    </div>
                                    <!-- End Website -->
                                    ...
                                    <div class="form-group mb-20">
                                        <label class="mb-2 font-14 bold black"
                                            for="phone_number">{{ trans('cruds.organization.fields.phone_number') }}</label>
                                        <input
                                    ...
                                    <div class="form-group mb-20">
                                        <label class="mb-2 font-14 bold black"
                                            for="organization_mobile_number">{{ trans('cruds.organization.fields.mobile_number') }}</label>
                                    ...
                                    <div class="form-group mb-20">
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.organization.fields.logo_helper') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-20">
                                        <label class="mb-2 font-14 bold black"
                                            for="position">{{ trans('cruds.user.fields.position') }}</label>
                                    ...
                                    <div class="form-group  mb-20 ">
                                        <label class="mb-2 font-14 bold black"
                                            for="identity_photos">{{ trans('cruds.user.fields.identity_photos') }}</label>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.user.fields.identity_photos_helper') }}</span>
                                    </div>
                                    <!-- End Identity photo -->
                                </div>
                            </div>
        ...
        Dropzone.options.partnershipAgreementDropzone = {
            ...
            init: function() {
                @if (isset($organization) && $organization->partnership_agreement)
                    ...
                    file.previewElement.classList.add('dz-complete')
                    $('form').append(
                        '<input class="btn style--two " type="hidden" name="partnership_agreement" value="' +
                        file.file_name +
                        '">')
                    this.options.maxFiles = this.options.maxFiles - 1
                @endif
            ...
            init: function() {
                @if (isset($user) && $user->identity_photos)
                    ...
                    for (var i in files) {
                        ...
                        file.previewElement.classList.add('dz-complete')
                        $('form').append(
                            '<input class="btn style--two " type="hidden" name="identity_photos[]" value="' +
                            file.file_name +
                            '">')
                    }
                @endif
