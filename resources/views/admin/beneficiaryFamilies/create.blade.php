            ...
            <form method="POST" action="{{ route('admin.beneficiary-families.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('qualifications') ? 'is-invalid' : '' }}" type="text"
                        name="qualifications" id="qualifications" value="{{ old('qualifications', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('job_sallary') ? 'is-invalid' : '' }}" type="number"
                        name="job_sallary" id="job_sallary" value="{{ old('job_sallary', '') }}" step="0.01">
                ...
                <div class="form-group">
                    <label class="required"
                        for="beneficiary_id">{{ trans('cruds.beneficiaryFamily.fields.beneficiary') }}</label>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('familyrelation') ? 'is-invalid' : '' }}"
                        ...
                        @foreach ($familyrelations as $id => $entry)
                            <option value="{{ $id }}" {{ old('familyrelation_id') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                        @endforeach
                    </select>
