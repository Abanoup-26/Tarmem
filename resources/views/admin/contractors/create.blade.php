                    ...
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <label class="required" for="contractor_type_id">{{ trans('cruds.contractor.fields.contractor_type') }}</label>
                                <select class="form-control select2 {{ $errors->has('contractor_type') ? 'is-invalid' : '' }}" name="contractor_type_id" id="contractor_type_id" required>
                                    @foreach($contractor_types as $id => $entry)
                                        <option value="{{ $id }}" {{ old('contractor_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                    @endforeach
                                </select>
                                ...
                                @endif
                                <span class="help-block">{{ trans('cruds.contractor.fields.contractor_type_helper') }}</span>
                            </div>
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control select2 {{ $errors->has('services') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($services as $id => $service)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('services', [])) ? 'selected' : '' }}>{{ $service }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-md-8">
                        <div class="row justify-content-around">
                            ...
                            <div class="form-group">
                                ...
                                <div class="needsclick dropzone {{ $errors->has('tax') ? 'is-invalid' : '' }}"
                                    id="tax-dropzone">
                                </div>
                                @if ($errors->has('tax'))
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <div class="needsclick dropzone {{ $errors->has('income') ? 'is-invalid' : '' }}"
                                    id="income-dropzone">
                                </div>
