                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"
                                    name="name" id="name" value="{{ old('name', $contractor->user->name) }}"
                                    required>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email"
                                    name="email" id="email" value="{{ old('email', $contractor->user->email) }}"
                                    required>
                                @if ($errors->has('email'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('email') }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('position', $contractor->user->position) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('mobile_number') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('mobile_number', $contractor->user->mobile_number) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('website', $contractor->website) }}" required>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select
                                    ...
                                    @foreach ($contractor_types as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('contractor_type_id') ? old('contractor_type_id') : $contractor->contractor_type->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group  col-md-12">
                                ...
                                <select class="form-control select2 {{ $errors->has('services') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($services as $id => $service)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('services', [])) || $contractor->services->contains($id) ? 'selected' : '' }}>
                                            {{ $service }}</option>
                                    @endforeach
                                </select>
