    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contractors.update", [$contractor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_number') ? 'is-invalid' : '' }}" type="text" name="mobile_number" id="mobile_number" value="{{ old('mobile_number', $contractor->user->mobile_number) }}">
