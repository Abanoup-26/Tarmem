...
@section('content')
    ...
    <div class="row text-start">
        <div class="col-2 mb-2">
            ...
            <span dir="ltr" style="font-size: 15px;font-weight: 600;text-decoration: underline;"> #{{ $building->id }} -
                {{ $building->name }} </span>
        </div>
    ...
    <div class="row">
        <div class="col-4 ">
            <div class="card ">
                <div class="card-header rounded-circle text-center" style="font-weight: bold"> <span
                        class="bg-light p-2 text-dark  rounded">حالة
                        المشروع</span>
                </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#building_building_supporters" role="tab"
                            data-toggle="tab" style="font-weight: bold; font-size: 20px; text-decoration: underline">
