            ...
            <form method="POST" action="{{ route('admin.buildings.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('building_type') ? 'is-invalid' : '' }}" name="building_type"
                        ...
                        @foreach (App\Models\Building::BUILDING_TYPE_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('building_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('building_number') ? 'is-invalid' : '' }}" type="number"
                        name="building_number" id="building_number" value="{{ old('building_number', '') }}" step="1"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('floor_count') ? 'is-invalid' : '' }}" type="number"
                        name="floor_count" id="floor_count" value="{{ old('floor_count', '') }}" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('apartments_count') ? 'is-invalid' : '' }}" type="number"
                        name="apartments_count" id="apartments_count" value="{{ old('apartments_count', '') }}"
                        step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('birth_data') ? 'is-invalid' : '' }}" type="text"
                        name="birth_data" id="birth_data" value="{{ old('birth_data') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('longtude') ? 'is-invalid' : '' }}" type="text"
                        name="longtude" id="longtude" value="{{ old('longtude', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('management_statuses') ? 'is-invalid' : '' }}"
                        ...
                        @foreach (App\Models\Building::MANAGEMENT_STATUSES_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('management_statuses', 'pending') === (string) $key ? 'selected' : '' }}>
                                {{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('rejected_reson') ? 'is-invalid' : '' }}" type="text"
                        name="rejected_reson" id="rejected_reson" value="{{ old('rejected_reson', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('stages') ? 'is-invalid' : '' }}" name="stages"
                        ...
                        @foreach (App\Models\Building::STAGES_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('stages', 'managment') === (string) $key ? 'selected' : '' }}>{{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('engineering_vist_date') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('engineering_vist_date') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('buidling_age') ? 'is-invalid' : '' }}" type="number" name="buidling_age" id="buidling_age" value="{{ old('buidling_age', '') }}" step="1" required>
