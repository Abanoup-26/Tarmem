        ...
        <div class="modal-content">
            ...
            @if ( $building->stages == 'managment' && $building->rejected_reson == null)
                <form method="post" action="{{ route('admin.buildings.update', [$building->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                            ...
                            <input type="hidden" name="stages" value="{{$building->stages}}">
            ...
            @if ($building->stages == 'engineering' && $building->research_vist_date == null)
                <form method="post" action="{{ route('admin.buildings.update', [$building->id]) }}" enctype="multipart/form-data">
                    ...
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" name="management_statuses" value="{{$building->management_statuses}}">
                ...
                <form method="post" action="{{ route('admin.buildings.update', [$building->id]) }}" enctype="multipart/form-data">
                    ...
                    @csrf
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="stages" value="{{$building->stages}}">
                            <div class="form-group">
                                <label for="engineering_vist_result">{{ trans('cruds.building.fields.engineering_vist_result')
                                    }}</label>
