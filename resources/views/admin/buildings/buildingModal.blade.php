        ...
        <div class="modal-content">
                ...
                <form method="post" action="{{ route('admin.buildings.update', [$building->id]) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="rejected_reson"
                                class="required">{{ trans('cruds.building.fields.rejected_reson') }}</label>
                            <input class="form-control {{ $errors->has('rejected_reson') ? 'is-invalid' : '' }}"
                                type="text" name="rejected_reson" id="rejected_reson"
            ...
            @if ($building->stages == 'engineering' && $building->research_vist_date == null)
                <form method="post" action="{{ route('admin.buildings.update', [$building->id]) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="research_vist_date"
                                class="required">{{ trans('cruds.building.fields.research_vist_date') }}</label>
                            <input
                                class="form-control date {{ $errors->has('research_vist_date') ? 'is-invalid' : '' }}"
                            ...
                            @endif
                            <span
                                class="help-block">{{ trans('cruds.building.fields.research_vist_date_helper') }}</span>
                        </div>
                    </div>
                    <div class="modal-footer form-group">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            ...
            @if ($building->stages == 'research_visit' && $building->research_vist_result == null)
                <form method="post" action="{{ route('admin.buildings.update', [$building->id]) }}"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="research_vist_result"
                                class="required">{{ trans('cruds.building.fields.research_vist_result') }}</label>
                            ...
                            @endif
                            <span
                                class="help-block">{{ trans('cruds.building.fields.research_vist_result_helper') }}</span>
                        </div>
                    </div>
                    <div class="modal-footer form-group">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            ...
            @if (
                $building->stages == 'research_visit' &&
                    $building->engineering_vist_date == null &&
                    $building->research_vist_result != null)
                <form method="post" action="{{ route('admin.buildings.update', [$building->id]) }}"
                    enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="managment_statuses" value="">
                        <div class="form-group">
                            <label for="engineering_vist_date"
                                class="required">{{ trans('cruds.building.fields.engineering_vist_date') }}</label>
                            <input
                                class="form-control date {{ $errors->has('engineering_vist_date') ? 'is-invalid' : '' }}"
                            ...
                            @endif
                            <span
                                class="help-block">{{ trans('cruds.building.fields.engineering_vist_date_helper') }}</span>
                        </div>
                    </div>
                    <div class="modal-footer form-group">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            ...
            @if ($building->stages == 'engineering_visit' && $building->engineering_vist_result == null)
                <form method="post" action="{{ route('admin.buildings.update', [$building->id]) }}"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" name="stages" value="Finances">
                            <input type="hidden" name="management_statuses" value="finances">
                            <label for="engineering_vist_result"
                                class="required">{{ trans('cruds.building.fields.engineering_vist_result') }}</label>
                            ...
                            @endif
                            <span
                                class="help-block">{{ trans('cruds.building.fields.engineering_vist_result_helper') }}</span>
                        </div>
                    </div>
                    <div class="modal-footer form-group">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
