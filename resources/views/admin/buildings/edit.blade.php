    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.buildings.update", [$building->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('building_number') ? 'is-invalid' : '' }}" type="number" name="building_number" id="building_number" value="{{ old('building_number', $building->building_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('floor_count') ? 'is-invalid' : '' }}" type="number" name="floor_count" id="floor_count" value="{{ old('floor_count', $building->floor_count) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apartments_count') ? 'is-invalid' : '' }}" type="number" name="apartments_count" id="apartments_count" value="{{ old('apartments_count', $building->apartments_count) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('birth_data') ? 'is-invalid' : '' }}" type="text" name="birth_data" id="birth_data" value="{{ old('birth_data', $building->birth_data) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longtude') ? 'is-invalid' : '' }}" type="text" name="longtude" id="longtude" value="{{ old('longtude', $building->longtude) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('management_statuses') ? 'is-invalid' : '' }}" name="management_statuses" id="management_statuses">
                    ...
                    @foreach(App\Models\Building::MANAGEMENT_STATUSES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('management_statuses', $building->management_statuses) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rejected_reson') ? 'is-invalid' : '' }}" type="text" name="rejected_reson" id="rejected_reson" value="{{ old('rejected_reson', $building->rejected_reson) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('stages') ? 'is-invalid' : '' }}" name="stages" id="stages">
                    ...
                    @foreach(App\Models\Building::STAGES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('stages', $building->stages) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('research_vist_date') ? 'is-invalid' : '' }}" type="text" name="research_vist_date" id="research_vist_date" value="{{ old('research_vist_date', $building->research_vist_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('engineering_vist_date') ? 'is-invalid' : '' }}" type="text" name="engineering_vist_date" id="engineering_vist_date" value="{{ old('engineering_vist_date', $building->engineering_vist_date) }}">
