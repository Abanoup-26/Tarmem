                ...
                <div class="col-xl-6 col-lg-9">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group mb-20">
                            ...
                            <input class="theme-input-style" type="email" name="email" value="{{ old('email') }}" placeholder="البريد الألكتروني" required autofocus autocomplete="email"/>
                                @if($errors->has('email'))
                        ...
                        <div class="form-group mb-20">
                            ...
                            <input class="theme-input-style"type="password" name="password" placeholder="كلمة المرور" required/>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="font-12 d-block"><a href="{{route('frontend.register')}}" class="bold">تسجيل جهه جديدة</a>
                            </span>
                        </div>
                    </form>
                </div>
